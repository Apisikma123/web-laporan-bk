...
@section('content')
<form method="POST" action="{{ route('register.teacher') }}" class="space-y-8">
    @csrf

    <!-- Email Verified Info -->
    <div class="bg-gradient-to-r from-emerald-50 to-green-50 rounded-2xl border border-emerald-200 p-6">
        <div class="flex items-center">
            <div class="flex-shrink-0">
                <div class="w-12 h-12 rounded-full bg-gradient-to-r from-emerald-100 to-green-100 flex items-center justify-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="relative group">
                    ...
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400 group-hover:text-purple-500 transition duration-200" 
            ...
            <div>
                ...
                <p class="mt-2 text-sm text-gray-500">Gunakan NIP resmi atau ID sekolah</p>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="relative group">
                    <input id="password" name="password" type="password" required
                           class="block w-full pl-12 pr-12 py-4 text-lg border-2 border-gray-200 rounded-xl 
                                  bg-white focus:border-purple-500 focus:ring-4 focus:ring-purple-100 
                                  focus:outline-none transition duration-200 placeholder-gray-400
                                  hover:border-purple-300"
                ...
                <div class="mt-3 space-y-2">
                    <div class="flex items-center">
                        <div id="length-check" class="w-3 h-3 rounded-full bg-gray-200 mr-2"></div>
            ...
            <div>
                ...
                <div class="mt-3">
                    <div class="flex items-center">
                        <div id="match-check" class="w-3 h-3 rounded-full bg-gray-200 mr-2"></div>
            ...
            <!-- Terms Agreement -->
<div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100 p-5 mt-6">
